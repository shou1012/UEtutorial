...
unrealRootPath=/home/sdjikken/GitHub/UnrealEngine
MyProjectRootPath=/home/sdjikken/workspace/MyProject

gameProjectFile=/home/sdjikken/workspace/MyProject/MyProject.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MyProjectSource.pri)
include(MyProjectHeader.pri)
include(MyProjectConfig.pri)
include(MyProjectIncludes.pri)
include(MyProjectDefines.pri)
...
MyProject-Linux-Debug.commands = $$build MyProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyProject-Linux-DebugGame.commands = $$build MyProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyProject-Linux-Shipping.commands = $$build MyProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyProject-Linux-Test.commands = $$build MyProject Linux Test  -project="\"$$gameProjectFile\"" $$args
MyProject.commands = $$build MyProject Linux Development  -project="\"$$gameProjectFile\"" $$args

MyProjectEditor-Linux-Debug.commands = $$build MyProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyProjectEditor-Linux-DebugGame.commands = $$build MyProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyProjectEditor-Linux-Shipping.commands = $$build MyProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyProjectEditor-Linux-Test.commands = $$build MyProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MyProjectEditor.commands = $$build MyProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
